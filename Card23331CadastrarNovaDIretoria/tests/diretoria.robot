...
=======
    ${nome_final_formatado}=     Set Variable              ${nome_base.capitalize()}
    ${body}=                     Create Dictionary         name=${nome_final_formatado}
    ${resp}=                     Cadastrar nova diretoria    ${nome_final_formatado}
    Status Should Be             201                       ${resp}
    Dictionary Should Contain Key     ${resp.json()}     newBoard
    Dictionary Should Contain Key   ${resp.json()}[newBoard]    _id
    Should Be Equal As Strings      ${resp.json()}[newBoard][boardName]    ${nome_final_formatado}
>>>>>>> fe7fbda69ad8e7615ea2a4bde7a63c7709b68ec7
...
CT04: Não permitir cadastrar diretoria com nome abaixo do limite minimo (1 caractere)  # está com BUG
    [Tags]     POST    negative    
=======
    ${nome_final_formatado}=     Set Variable              ${nome_composto_completo.capitalize()}
    ${body}=                     Create Dictionary         name=${nome_final_formatado}
    ${resp}=                     Cadastrar nova diretoria    ${nome_final_formatado}
    Status Should Be             201                       ${resp}
    Dictionary Should Contain Key     ${resp.json()}     newBoard
...
CT03: Cadastrar diretoria com nome prefixado e com acentos
    [Tags]     POST    regression
    ${nome_com_acento_base}=     Generate Random String    12    chars=${CHARS_COM_ACENTOS}
    ${nome_prefixado_com_acento}=  Set Variable              E${nome_com_acento_base}
    ${nome_final_formatado}=     Set Variable              ${nome_prefixado_com_acento.capitalize()}
    ${body}=                     Create Dictionary         name=${nome_final_formatado}
    ${resp}=                     Cadastrar nova diretoria    ${nome_final_formatado}
    Status Should Be             201                       ${resp}
    Dictionary Should Contain Key     ${resp.json()}     newBoard
...
CT04: Nao permitir cadastrar diretoria com nome abaixo do limite minimo (1 caractere)  # está com BUG
    [Tags]     POST    negative    boundary
>>>>>>> fe7fbda69ad8e7615ea2a4bde7a63c7709b68ec7
...
CT05: Não permitir cadastrar diretoria com nome acima do limite maximo (51 caracteres)
    [Tags]     POST    negative    
=======
CT05: Nao permitir cadastrar diretoria com nome acima do limite maximo (51 caracteres)
    [Tags]     POST    negative    boundary
>>>>>>> fe7fbda69ad8e7615ea2a4bde7a63c7709b68ec7
...
=======
CT06: Nao permitir cadastrar diretoria com nome duplicado
>>>>>>> fe7fbda69ad8e7615ea2a4bde7a63c7709b68ec7
    [Tags]     POST    negative
...
=======
    ...
    diretoria.Cadastrar nova diretoria    ${nome_duplicado_com_prefixo}
>>>>>>> fe7fbda69ad8e7615ea2a4bde7a63c7709b68ec7
...
=======
CT07: Nao permitir cadastrar diretoria com nome vazio
>>>>>>> fe7fbda69ad8e7615ea2a4bde7a63c7709b68ec7
    [Tags]     POST    negative
...
CT08: Não permitir cadastro de diretoria com caracteres especiais inválidos
    ...
    END
=======
    Should Contain               ${resp_erro.json()}[error][0]     ${MSG_ERRO_OBRIGATORIO}
...
=======
CT09: Consultar a lista de diretorias com sucesso
    [Tags]     GET    smoke
    Create Session     alias=supernatural    url=${BASE_URL}    verify=${True}
    ${body}=           Create Dictionary    mail=${ADMIN_EMAIL}    password=${ADMIN_PASSWORD}
    ${response_login}=   POST On Session       alias=supernatural    url=/login    json=${body}
    ${json_response_login}=   Set Variable     ${response_login.json()}
    ${token_obtido}=       Set Variable     ${json_response_login["token"]} 
    Set Suite Variable    ${AUTH_TOKEN}      ${token_obtido}
    ${headers_com_auth}=    Create Dictionary
...
=======
CT11: Criar uma diretoria e consultar pelo seu ID
>>>>>>> fe7fbda69ad8e7615ea2a4bde7a63c7709b68ec7
...
=======
    ${resp_cadastro}=            diretoria.Cadastrar nova diretoria    ${nome_antigo_final}
>>>>>>> fe7fbda69ad8e7615ea2a4bde7a63c7709b68ec7
...
=======
CT18: Nao permitir editar o nome para um ja existente  # Está com BUG
>>>>>>> fe7fbda69ad8e7615ea2a4bde7a63c7709b68ec7
    [Tags]     PUT    negative
...
=======
CT20: Nao permitir editar o nome para vazio
>>>>>>> fe7fbda69ad8e7615ea2a4bde7a63c7709b68ec7
    [Tags]     PUT    negative
